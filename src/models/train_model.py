...
# IMPORTANT: This tells Python to store the class with a findable module name
# in the pickle, instead of '__main__' which breaks when loading from other scripts.
# Without this fix, joblib.load() fails with "Can't get attribute 'IPLEnsemblePredictor'"
